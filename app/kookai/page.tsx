...
const MENU = [
  {
    ...
    tag: "High Protein",
    tagColor: C.green,
    photo: "https://images.pexels.com/photos/1640777/pexels-photo-1640777.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&dpr=1",
    desc: "Grilled chicken, jasmine rice, steamed veggies, house sauce",
  },
  {
    name: "Salmon Quinoa",
    thai: "ควินัวแซลมอน",
    ...
    tag: "Omega-3",
    tagColor: "#0ea5e9",
    photo: "https://images.pexels.com/photos/1640772/pexels-photo-1640772.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&dpr=1",
    desc: "Atlantic salmon, quinoa, avocado, lemon dressing",
  },
  {
    ...
    tag: "Antioxidant",
    tagColor: "#7c3aed",
    photo: "https://images.pexels.com/photos/1099680/pexels-photo-1099680.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&dpr=1",
    desc: "Acai blend, granola, fresh berries, coconut flakes, honey",
  },
  {
    ...
    tag: "Low Cal",
    tagColor: C.lime,
    photo: "https://images.pexels.com/photos/1211887/pexels-photo-1211887.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&dpr=1",
    desc: "Kale, cucumber, avocado, pumpkin seeds, tahini dressing",
  },
  {
    name: "Protein Wrap",
    thai: "โปรตีนแรป",
    ...
    tag: "High Protein",
    tagColor: C.green,
    photo: "https://images.pexels.com/photos/1640770/pexels-photo-1640770.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&dpr=1",
    desc: "Whole wheat wrap, grilled chicken, hummus, crunchy veggies",
  },
  {
    name: "Mango Chia Smoothie",
    thai: "สมูทตี้มะม่วงเชีย",
    cal: "180 kcal",
    price: "69฿",
    tag: "Vegan",
    tagColor: "#f59e0b",
    photo: "https://images.pexels.com/photos/1132047/pexels-photo-1132047.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&dpr=1",
    desc: "Fresh mango, chia seeds, coconut milk, ginger, turmeric",
  },
];
          ...
          <div className={`relative transition-all duration-1000 delay-300 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
            <div className="relative">
              ...
              <div className="float relative overflow-hidden shadow-2xl" style={{ borderRadius: "2.5rem", border: `4px solid white`, height: "420px" }}>
                <img src="https://images.pexels.com/photos/1640777/pexels-photo-1640777.jpeg?auto=compress&cs=tinysrgb&w=700&h=500&dpr=1"
