...
const PROJECTS = [
  ...
  },
  {
    ...
    location: "Pattaya, Thailand",
    year: "2026",
    desc: "Premium snus & nicotine pouches shop. Scandinavian design, 2 locations, full product catalogue with brands, flavors and strength levels.",
    tags: ["Snus", "Retail", "Scandinavian"],
    gradient: "from-blue-950 via-zinc-900 to-black",
    accent: "#0066CC",
    accentText: "text-blue-400",
    photo: "https://images.pexels.com/photos/3962294/pexels-photo-3962294.jpeg?auto=compress&cs=tinysrgb&w=800&h=400&dpr=1",
    liveUrl: "/svens",
    status: "Preview",
    cardType: "photo",
  },
